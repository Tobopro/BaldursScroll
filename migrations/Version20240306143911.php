 ...
 */
final class Version20240306143911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, roles JSON NOT NULL, username VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, sign_in_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, is_banned TINYINT(1) DEFAULT 0 NOT NULL, is_flaged TINYINT(1) DEFAULT 0 NOT NULL, is_public TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
